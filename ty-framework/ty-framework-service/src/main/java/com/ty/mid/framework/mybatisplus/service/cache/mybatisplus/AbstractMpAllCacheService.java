 ...
 * 注意:
 * 1.此类适合缓存如字典,全国市区等基本不变且数量不多的场景,如果经常改变或者数据量超过500,请慎用此方法,这会影响系统启动速度
 ...
 */
@Slf4j
public abstract class AbstractMpAllCacheService<T extends AbstractDO<ID>, ID extends Serializable, M extends BaseMapperX<T>, D extends AbstractDTO> extends AbstractGenericService<T, ID, M, D> implements CacheService<T, ID, D> {
