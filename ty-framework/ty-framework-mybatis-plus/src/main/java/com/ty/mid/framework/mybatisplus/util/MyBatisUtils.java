...
import com.ty.mid.framework.common.pojo.SortField;
import com.ty.mid.framework.common.pojo.SortParam;
...
public class MyBatisUtils {
    ...
    public static <T> Page<T> buildPage(PageParam pageParam) {
        // 页码 + 数量
        Collection<SortField> orderFields = pageParam.getOrderFields();
