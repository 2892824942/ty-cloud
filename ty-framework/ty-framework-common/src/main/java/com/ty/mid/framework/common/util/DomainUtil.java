...
import com.ty.mid.framework.common.dto.KeyValueDTO;
...
public abstract class DomainUtil {
     ...
     * @return
     */
    public static Map<String, Object> renameKeyValue(@NonNull KeyValueDTO dto, @NonNull String keyName, @NonNull String valueName) {
        if (dto == null) {
            return null;
        }
     ...
     * @return
     */
    public static Collection<Map<String, Object>> renameKeyValue(@NonNull Collection<KeyValueDTO> dtos, @NonNull String keyName, @NonNull String valueName) {
        if (dtos == null) {
            return null;
        }
