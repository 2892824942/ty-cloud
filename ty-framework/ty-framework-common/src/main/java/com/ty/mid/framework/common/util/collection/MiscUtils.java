...
public final class MiscUtils {
    ...
    public static <V, V1 extends V> Map<String, V> toLinkedHashMap(String name1, V1 value1) {
        return populateMap(new LinkedHashMap<String, V>(), name1, value1);
    }
    ...
    public static <V, V1 extends V, V2 extends V> Map<String, V> toLinkedHashMap(String name1, V1 value1, String name2, V2 value2) {
        return populateMap(new LinkedHashMap<String, V>(), name1, value1, name2, value2);
    }
    ...
    public static <V, V1 extends V, V2 extends V, V3 extends V> Map<String, V> toLinkedHashMap(String name1, V1 value1, String name2, V2 value2, String name3, V3 value3) {
        return populateMap(new LinkedHashMap<String, V>(), name1, value1, name2, value2, name3, value3);
    }
    ...
    public static <V, V1 extends V, V2 extends V, V3 extends V, V4 extends V> Map<String, V> toLinkedHashMap(String name1, V1 value1, String name2, V2 value2, String name3, V3 value3, String name4, V4 value4) {
        return populateMap(new LinkedHashMap<String, V>(), name1, value1, name2, value2, name3, value3, name4, value4);
    }
    ...
    public static <V, V1 extends V, V2 extends V, V3 extends V, V4 extends V, V5 extends V> Map<String, V> toLinkedHashMap(String name1, V1 value1, String name2, V2 value2, String name3, V3 value3, String name4, V4 value4, String name5, V5 value5) {
        return populateMap(new LinkedHashMap<String, V>(), name1, value1, name2, value2, name3, value3, name4, value4, name5, value5);
    }
    ...
    public static <V, V1 extends V, V2 extends V, V3 extends V, V4 extends V, V5 extends V, V6 extends V> Map<String, V> toLinkedHashMap(String name1, V1 value1, String name2, V2 value2, String name3, V3 value3, String name4, V4 value4, String name5, V5 value5, String name6, V6 value6) {
        return populateMap(new LinkedHashMap<String, V>(), name1, value1, name2, value2, name3, value3, name4, value4, name5, value5, name6, value6);
    }
    ...
    public static List<Map<Object, Object>> sortMaps(List<Map<Object, Object>> listOfMaps, List<? extends String> sortKeys) {
        ...
        try {
            ...
            log.warn("Problems sorting list of maps; returning null.", e);
            return null;
        }
        return toSort;
    }
    ...
    public static <T> Set<T> toSet(T obj1, T obj2, T obj3, T obj4, T obj5, T obj6, T obj7) {
        Set<T> theSet = new LinkedHashSet<T>();
        theSet.add(obj1);
        theSet.add(obj2);
        theSet.add(obj3);
    ...
    public static Locale parseLocale(String localeString) {
        ...
        if (localeString.length() == 2) {
            ...
            log.warn("Do not know what to do with the localeString [" + localeString + "], should be length 2, 5, or greater than 6, returning null");
        }
