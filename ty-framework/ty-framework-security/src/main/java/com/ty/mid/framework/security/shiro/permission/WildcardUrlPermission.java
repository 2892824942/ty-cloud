 ...
 * @since 0.9
 */
public class WildcardUrlPermission implements Permission, Serializable {
     ...
     */
    protected WildcardUrlPermission() {
    }

    public WildcardUrlPermission(String wildcardString) {
        this(wildcardString, DEFAULT_CASE_SENSITIVE);
    }

    public WildcardUrlPermission(String wildcardString, boolean caseSensitive) {
    ...
    public boolean implies(Permission p) {
        ...
        if (!(p instanceof WildcardUrlPermission)) {
            return false;
        }

        WildcardUrlPermission wp = (WildcardUrlPermission) p;
    ...
    public boolean equals(Object o) {
        if (o instanceof WildcardUrlPermission) {
            WildcardUrlPermission wp = (WildcardUrlPermission) o;
